...
import 'package:trashmeep/modal/transaksikategori.dart';
        ...
        child: new Card(
          ...
          child: Center(
            ...
            children: <Widget>[
              ...
              Text(
                "Nilai Poin: ${widget.list[widget.index]['nilai_kategori']}",
              ...
              new Row(
                ...
                new RaisedButton(
                  child : new Text("TUKAR SAMPAH"),
                  color : Colors.blueAccent,
                  textColor: Colors.white,
                  onPressed : () => Navigator.of(context).push(
                    new MaterialPageRoute(builder: (BuildContext context) => new TransaksiKategori())
                  )
                )
                ],
              )
