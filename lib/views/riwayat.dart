...
import 'package:trashmeep/modal/detailkategori.dart';
...
class _RiwayatState extends State<Riwayat> {
  Future<List> getData() async {
    final response = await http.get("http://192.168.1.6/trashmee/transaksi/riwayat.php");
          ...
          child: new GestureDetector(
            ...
            child: new Card(
              child: new ListTile(
                ...
                subtitle: new Text("Kirim Poin : ${list[i]['kirim_poin']}"),
              ),
            ),
          ),
        );
